    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-sm font-medium text-gray-600">
          Theo dõi và xử lý đơn hàng, trạng thái vận chuyển
        </p>
      </div>
      ...
      >
        <div className="flex flex-col items-center justify-center py-12 text-center lg:py-20">
          ...
          >
            <ShoppingCart className="w-8 h-8 text-white lg:w-10 lg:h-10" />
          </div>
          ...
          <p className="max-w-md text-sm font-medium text-gray-600 lg:text-base">
            Chức năng quản lý đơn hàng sẽ sớm được cập nhật. Vui lòng quay lại sau!
          </p>
        </div>
      </div>
    </div>
