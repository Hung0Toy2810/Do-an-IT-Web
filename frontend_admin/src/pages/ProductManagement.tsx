    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-sm font-medium text-gray-600">
          Quản lý thông tin sản phẩm, giá cả, tồn kho và danh mục
        </p>
      </div>
      ...
      >
        <div className="flex flex-col items-center justify-center py-12 text-center lg:py-20">
          ...
          >
            <Package className="w-8 h-8 text-white lg:w-10 lg:h-10" />
          </div>
          ...
          <p className="max-w-md text-sm font-medium text-gray-600 lg:text-base">
            Chức năng quản lý sản phẩm sẽ sớm được cập nhật. Vui lòng quay lại sau!
          </p>
        </div>
      </div>
    </div>
