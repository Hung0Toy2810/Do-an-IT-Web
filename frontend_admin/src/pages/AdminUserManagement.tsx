    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-sm font-medium text-gray-600">
          Quản lý tài khoản quản trị viên, phân quyền và bảo mật
        </p>
      </div>
      ...
      >
        <div className="flex flex-col items-center justify-center py-12 text-center lg:py-20">
          ...
          >
            <Shield className="w-8 h-8 text-white lg:w-10 lg:h-10" />
          </div>
          ...
          <p className="max-w-md text-sm font-medium text-gray-600 lg:text-base">
            Chức năng quản lý quản trị viên sẽ sớm được cập nhật. Vui lòng quay lại sau!
          </p>
        </div>
      </div>
    </div>
